...
public class TasVisible extends Tas {
	...
	/**
	 * Edit : j'ai ajouté cette méthode pour faciliter l'échanger de carte, pour
	 * pouvoir échanger à une position donnée
	 * 
	 * @param position
	 * @return la première carte de la liste.
	 */
	...
	/**
	 * Méthode qui permet de savoir si le TasVisible contient des cartes
	 * spéciales
	 * 
	...
	/**
	 * Méthode qui permet de récupérer une carte spéciale contenue dans le
	 * TasVisible. Elle retourne en priorité les cartes spéciales As et Huit
	 * 
	 * @return une carte spéciale, en priorité un As, ou un huit ou null s'il
	 *         n'y a plus de carte spéciale
	 */
